        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/reservasi" :active="request()->is('reservasi')">Halaman Reservasi</x-nav-link>
              <x-nav-link href="/konfirmasi" :active="request()->is('konfirmasi')">Halaman Konfirmasi Reservasi</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
